...
?>
    <section id="productPage">
        <h2>Notre <span>biscuiterie</span></h2>
        <div id="filtre">
            ...
            <a class="dropdown-item active" href="biscuiterie.php">Biscuiterie</a>
        </div>
        <div id="displayPageProduct">
            <?php
            require_once('connectdb.php');
            $sql = "SELECT * FROM product WHERE product_categorie = 'biscuiterie'";
